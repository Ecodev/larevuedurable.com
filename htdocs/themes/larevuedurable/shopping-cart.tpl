...
{/if}
<div class='mceContentBody'><p>{l s='Your shopping cart contains:'} <span id="summary_products_quantity">{$productNumber} {if $productNumber == 1}{l s='product'}{else}{l s='products'}{/if}</span></p></div>
<div id="order-detail-content" class="table_block mceContentBody">
