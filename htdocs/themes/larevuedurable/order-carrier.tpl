...
<div class="order_carrier_content mceContentBody">
...
{else}
	<div class='mceContentBody' style='margin:0 15px;'>
		<h3>{l s='Leave a message'}</h3>
		<div>
			<p>{l s='If you would like to add a comment about your order, please write it in the field below.'}</p>
			<p><textarea cols="100" rows="3" name="message" id="message">{if isset($oldMessage)}{$oldMessage|escape:'htmlall':'UTF-8'}{/if}</textarea></p>
		</div>
	</div>
</div>
{/if}
