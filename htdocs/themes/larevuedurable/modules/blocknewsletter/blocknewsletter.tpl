...
<div id="newsletter_block_left" class="block">
	...
	{/if}
		<form id='newsletterform' action="{$link->getPageLink('index')}" method="post">
			<p>
				{* @todo use jquery (focusin, focusout) instead of onblur and onfocus *}
				<input type="text" name="email" size="18" 
					id='inputHomeNewsletter'
					...
					class="inputNew" />
					<input type="submit" value="ok" class="button_mini" name="submitNewsletter" id='submitNewsletter'/>
		...
		<p class='descHomeNewsletter'>
			{l s='je désire être tenu au courant des dernières parutions, infos, actions et nouveautés de LaRevueDurable' mod='blocknewsletter'}
		</p>
