...
<div class='mceContentBody'><p>{l s='Please configure your default billing and delivery addresses when placing an order. You may also add additional addresses, which can be useful for sending gifts or receiving an order at your office.'}</p></div>

{if isset($multipleAddresses) && $multipleAddresses}
<div class="addresses">
	<h3>{l s='Your addresses are listed below.'}</h3>
	<div class='mceContentBody'><p>{l s='Be sure to update your personal information if it has changed.'}</p></div>
