...
{*
Symlinked in htdocs/administrator/themes/default/template/helpers/list/list_header.tpl
*}
			...
			{literal}
				$(window).bind('scroll', function() {
					if ($(window).scrollTop() > 120) {
						$('.menuFilterUp').addClass('fixed')
					}
					else {
						$('.menuFilterUp').removeClass('fixed')
					}
				});
			{/literal}
