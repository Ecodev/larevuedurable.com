...
<div id="step1">
	...
	{* global information *}
		...
		<tr>
		   <td class="col-left"><label>{$bullet_common_field} {l s='Date de parution :'}</label></td>
		   <td style="padding-bottom:5px;">
		        <input type="text" name="date_parution" id="date_parution" value="{$product->date_parution}" class="datepicker"  style="width: 130px; margin-right: 44px;" />
		   </td>
		  </tr>
		<tr>
