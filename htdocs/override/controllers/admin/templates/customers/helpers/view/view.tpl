...
<div id="container-customer">
	...
	<div class="info-customer-left">
		...
		{l s='Crésus ID:'} {$customer->cresus_id}<br />
    ...
    {if isset($customer->subscriptions) && count($customer->subscriptions)}
            <table  class="table media_list" cellspacing="0" cellpadding="0" >
                <tr>
                    ...
                    <th>{l s='Premier numéro'}</th>
                    <th>{l s='Dernier numéro'}</th>
                    <th>{l s='Autorisations'}</th>
                </tr>

            {foreach from=$customer->subscriptions item=sub name=myLoop}
                <tr>
                    <td>
                        <p>{$sub->order->reference}<p>
                    </td>
                    <td>
                        <p>{$sub->order->date_add|date_format:"%A %e %B %Y"}</p>
                    </td>
                    <td>
                        <p>{$sub->product_attributes_name}</p>
                    </td>
                    <td>
                        <p>{$sub->first_edition}</p>
                    </td>
                    <td>
                        <p>{$sub->last_edition}</p>
                    </td>
                    <td colspan='2'>
