	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage	: '../modules/devpro/libs/jquery_progressbar/img/progressbar.gif',		// boxImage : image around the progress bar
				barImage	: '../modules/devpro/libs/jquery_progressbar/img/progressbg_green.gif',	// Image to use in the progressbar. Can be an array of images too.
