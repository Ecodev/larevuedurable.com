...
class BlockSearch extends Module
{
	...
	{
		if (!parent::install() || !$this->registerHook('displayTopCategory') || !$this->registerHook('top') || !$this->registerHook('header') || !$this->registerHook('displayHome') || !$this->registerHook('displayMobileTopSiteMap'))
			return false;
		return true;
	}
...
*/
	...
	public function hookDisplayTopCategory($params)
	{
		return $this->hookDisplayHome($params);	
	}
	public function hookDisplayHome($params)
	{
		if (!$this->isCached('blocksearch-home.tpl', $this->getCacheId('blocksearch-home')))
		{
			$this->calculHookCommon($params);
			$this->smarty->assign('blocksearch_type', 'home');
		}

		return $this->display(__FILE__, 'blocksearch-home.tpl', $this->getCacheId('blocksearch-home'));
	}
