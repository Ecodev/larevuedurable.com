...
class Blocknewsletter extends Module
{
	...
	{
		Tools::createHookIfNoExist('displayHomeCol3', 'Accueil : troisième colonne');
		if (parent::install() == false || $this->registerHook('displayHomeCol3') == false || $this->registerHook('header') == false)
			return false;
