...
class BlockCms extends Module
{
	...
	{
		Tools::createHookIfNoExist('displayCMSNav', 'Navigation pour les pages CMS');
		return (
			$this->registerHook('displayCMSNav') && $this->registerHook('rightColumn') &&
	...
	public function hookDisplayCMSNav()
	{
