		...
		<li>
			<a href="{$slide.url|escape:'htmlall':'UTF-8'}" title="{$slide.description|escape:'htmlall':'UTF-8'}">
				<div class='slide_labels'>
					<span class='slide_title'><span><span class='spacer'></span>{$slide.title}<span class='spacer'></span></span></span><br/>
					<span class='slide_desc'>{$slide.description}</span>
				</div>
